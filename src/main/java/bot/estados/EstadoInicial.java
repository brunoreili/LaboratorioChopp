...
public class EstadoInicial extends Estado{
    ...
    public void processaTexto(String texto) {
        ...
        if(cliente.getStatus().equals("Novo")){            
            mensagemResposta = "TESTE ---- " +
                               "Olá, " + cliente.getFirst_name() + " " + cliente.getLast_name() + "!" +System.lineSeparator() +
                               ...
                               "O total da sua comanda no momento é de R$ " + comanda.getTotal() + "0" + System.lineSeparator() +
